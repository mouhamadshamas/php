...
<body dir="rtl">
    ...
    <div class="container">
        <h1 class="text-center my-5">Products Laptop</h1>
            ...
            <div class="col-md-4">
                ...
                <!-- <img src="<?php //echo $_SERVER['REQUEST_URI'] ?>images/<?php //echo htmlspecialchars($row['image']); ?>" class="card-img-top product-image" alt="<?php //echo htmlspecialchars($row['namepr']); ?>"> -->
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><?php echo htmlspecialchars($row['namepr']); ?></h5>
                        <p class="card-text"><?php echo htmlspecialchars($row['description']); ?></p>
                        <p class="text-success fw-bold">$PRICE: <?php echo htmlspecialchars($row['price']); ?> </p>
                       
                        <a name="addto" class='btn btn-danger' href="val.php?id=<?= $row['idpr'] ?>">Add to card</a>
                    </div>
                </div>
            </div>
            <?php
