...
?>
            ...
            <div class="col-md-4">
                ...
                <!-- <img src="<?php //echo $_SERVER['REQUEST_URI'] ?>images/<?php //echo htmlspecialchars($row['image']); ?>" class="card-img-top product-image" alt="<?php //echo htmlspecialchars($row['namepr']); ?>"> -->
                    ...
                    <img src="admin/<?php echo $row['imageacc'] ?>" >
                


                    <div class="card-body">
                    
                        <h5 class="card-title"><?php echo htmlspecialchars($row['nameacc']); ?></h5>
                        <p class="card-text"><?php echo htmlspecialchars($row['descriptionacc']); ?></p>
                        <p class="text-success fw-bold">$PRICE: <?php echo htmlspecialchars($row['priceacc']); ?> </p>
                       
                        <a name="addto" class='btn btn-danger' href="valacc.php?id=<?= $row['idacc'] ?>">Add to card</a>
                    </div>
                </div>
            </div>
            <?php
